...
int main(int argc, char *argv[])
{
    ...
    glbDefineProjection(free,GLB_FREE,GLB_FREE,GLB_FIXED,GLB_FIXED,GLB_FIXED,GLB_FIXED);
    ...
    FILE* File=fopen("data/ModelTest_th23_dCP_WFS(MOMENT).dat", "w");
    ...
    PARA=MODEL;
        ...
        glbSetOscParams(test_values,0.92*M_PI,1);
        float res=glbChiNP(test_values,NULL,0);
        glbSetOscParams(test_values,1.05*M_PI,1);
        float res2=glbChiNP(test_values,NULL,0);
